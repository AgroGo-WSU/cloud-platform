/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57ea21b0292e739f5ad7c46250fa9b16)
// Runtime types generated with workerd@1.20250917.0 2025-09-11 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "StreamingObject";
	}
	interface Env {
		FIREBASE_PROJECT_ID: "agrogo-c4f0e";
		FIREBASE_API_KEY: "AIzaSyD5H47l8jzAJeve392CLEPPRVWFad40KJE";
		d1_access_api_token: string;
		account_id: string;
		database_id: string;
		STREAMING_OBJECT: DurableObjectNamespace<import("./src/index").StreamingObject>;
		DB: D1Database;
	}
}
